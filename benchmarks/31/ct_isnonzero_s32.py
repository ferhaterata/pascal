...
folder_name = './benchmarks/31/'
file_name = 'ct_isnonzero_s32.o'
proj = angr.Project(folder_name + file_name,
                    load_options={"auto_load_libs": False, 'main_opts': {'base_addr': base_addr}})
func_name = 'ct_isnonzero_s32'
prototype = angr.types.parse_defns('int ct_isnonzero_s32(uint32_t x);')[func_name]
