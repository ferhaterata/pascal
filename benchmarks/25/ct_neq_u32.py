...
folder_name = './benchmarks/25/'
file_name = 'ct_neq_u32.o'
proj = angr.Project(folder_name + file_name,
                    load_options={"auto_load_libs": False, 'main_opts': {'base_addr': base_addr}})

func_name = 'ct_neq_u32'
prototype = angr.types.parse_defns('int ct_neq_u32(uint32_t x, uint32_t y);')[func_name]
...
state: angr.SimState = proj.factory.call_state(addr, x, y, prototype=prototype)
